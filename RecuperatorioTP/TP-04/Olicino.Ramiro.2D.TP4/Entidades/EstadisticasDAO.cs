...
namespace Entidades
{
    ...
    public static class EstadisticasDAO
    {
        ...
        static EstadisticasDAO()
        {
            ...
            connection = new SqlConnection(JugadorDAO.ConnectionString);
        ...
        public static bool AgregarEstadisticas(Estadisticas estadistica)
        {
            try
            {
                if (ClubBernaleza.ListaJugadoresActivos.Count <= 0)
                {
                    throw new JugadorExcepcion("Primero debera cargar jugadores en el club");
                }
        ...
        private static void Actualizar(Estadisticas estadistica)
        {
            try
            {
                if (ClubBernaleza.ListaJugadoresActivos.Count <= 0)
                {
                    throw new JugadorExcepcion("Error! Primero debera cargar jugadores en el club");
                }
